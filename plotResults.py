...
def main():
    models = ["nnunet", "unet_v2_1",  "unet_v2_3", "unet_v2_4", "unet_v2_5", "unet_v2_6s", "unet_v4_1"]
    names = ["nnunet", "random, (50, 99.5)",  "weighted, (50, 99.5)", "weighted (2.5, 99.5)", "random (2.5, 99.5)", "random, no clip", "random (2.5, 99.5)"]
